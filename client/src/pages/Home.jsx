  ...
  return (
    <AppShell>
      <section className="border-b border-[var(--border)]">
        <Container>
          <div className="grid min-h-[calc(100svh-96px)] grid-cols-1 lg:grid-cols-2">
            ...
            <div className="flex flex-col justify-between border-b border-[var(--border)] py-8 lg:border-b-0 lg:border-r lg:py-10 lg:pr-12">
              ...
              <div className="max-w-2xl py-16 lg:py-0">
                ...
                <div className="mt-9 flex flex-wrap items-center gap-8">
                  ...
                  <Link
                    to="/register"
                    className="group inline-flex items-center gap-3 text-sm font-bold uppercase tracking-[0.12em] text-[var(--muted)] transition-colors hover:text-[var(--foreground)]"
                  >
